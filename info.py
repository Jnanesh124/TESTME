...
PICS = (environ.get('PICS', 'https://i.ibb.co/gqd6tBn/x.jpg')).split()
...
SUPPORT_CHAT_ID = int(environ.get('SUPPORT_CHAT_ID', '-1002145653614'))
...
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'JN2FLIX_KANNADA') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.


# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/JNK_BACKUP')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/JNK_BACKUP')
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', 'dc64f71dee43e715379e1da5d3bc9dbeb96b71a7')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://example.com/tutorial')
