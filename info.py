...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://strong:strong@cluster0.ix7usa3.mongodb.net/?retryWrites=true&w=majority") # Necessary If clone mode is true
